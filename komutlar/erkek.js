...
let role = message.guild.roles.get("738239593173745696")// Erkek rol id
let rolesil1 = message.guild.roles.get("738239593173745698")// Silinecek rol id
...
message.guild.members.get(kullanıcı.id).removeRole(rolesil1.id)
